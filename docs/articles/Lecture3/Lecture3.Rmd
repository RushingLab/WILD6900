...
Let's say we're sampling the number of trees on small plots and that we **_know_** the average number of trees/plot is 40 $^4$  
<br/>
...
+ $Pr(y=42|\lambda=40) =$ `r round(dpois(42,40),3)`  
<br/>
