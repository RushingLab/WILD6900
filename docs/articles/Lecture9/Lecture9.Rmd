...
ssm <- jagsUI::jags(data = jags.data, inits = inits, parameters.to.save = parameters, model.file = "ssm.jags", n.chains = nc, n.thin = nt, n.iter = ni, n.burnin = nb)
...
(p <- ggplot() + 
  ...
  geom_line(data = df, aes(x = Year, y = Observed), color = WILD6900_colors$value[WILD6900_colors$name=="primary"]) +
...
- Produce unbiased estimates of $N$ when counts are equally likely to be higher or lower than true abundance  

--
- Produce unbiased estimates of $Np$ when  
