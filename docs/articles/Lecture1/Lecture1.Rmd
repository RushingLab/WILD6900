...
ggplot(Nl, aes(x = Time, y = N)) + geom_path(color = WILD6900_colors$value[WILD6900_colors$name=="primary"]) + geom_point(color = WILD6900_colors$value[WILD6900_colors$name=="primary"], size = 2) 
...
ggplot(Nl) + geom_point(aes(x = Time, y = N), color = WILD6900_colors$value[WILD6900_colors$name=="primary"], size = 2) + 
  geom_path(aes(x = Time, y = N.pred), color = WILD6900_colors$value[WILD6900_colors$name=="secondary"]) 
