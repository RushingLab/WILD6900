...
5) All $N$ individuals have the same detection probability $p$
...
- Count data has less information about $p$ than mark-recapture data
...
- Mark-recapture data provides auxillary information about $p$ without reference to $N$

- Without auxillary information about $p$, count data cannot distinguish between N-mixture model or other possible models of $N$
...
- Estimates from N-mixture models sensitive to violation of double counting and constant $\lambda$/$p$

- Small violations unlikely to be detected using goodness‐of‐fit tests but can influence inference about $N$
