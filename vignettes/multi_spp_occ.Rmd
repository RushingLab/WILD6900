...
To treat species as random effects in this model, we will specificy a distribution for the species-specific occupancy probabilities:
...
Now we're ready to fit the model. As in the othe occupancy models we've seen, initial values for $x$ and $z$ are important (remember that we need $x$ and $z$ for the full augmented data set):
