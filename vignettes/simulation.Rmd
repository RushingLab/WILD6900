...
To generate the simulated seed counts for each flower, we first have to calcuate $\mu_i$, the *expected* seeds for each flower. We get these values by simply plugging in the observed visition values for each site to our linear model:
