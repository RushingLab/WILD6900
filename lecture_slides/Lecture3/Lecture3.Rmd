...
ggplot(data = y_probs, aes(x = y, y = pr_y)) + geom_point(color = WILD6900_colors$value[WILD6900_colors$name == "secondary"]) +
  scale_y_continuous(expression(paste("[y|", lambda, "=40]")))
...
(lik_profile <- ggplot(data = y_probs, aes(x = lambda, y = pr_y)) + geom_path(color = WILD6900_colors$value[WILD6900_colors$name == "dark"]) +
  scale_y_continuous(expression(paste("L(", lambda, "|y=42)"))) +
  scale_x_continuous(expression(lambda)))
